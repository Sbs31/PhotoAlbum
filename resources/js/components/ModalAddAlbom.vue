<template>
        <div class="wrap-modal" >
            <div class="modal-dialog">
                ...
                <div v-if="!isPhoto" class="modal-content">
                ...
                <div v-else class="modal-content row">

                    <div class="mb-3 p-3 col">
                        <label for="inputFileUpload" class="form-label">Добавить фото</label>
                        <input  class="form-control" v-on:change="onFileChange" type="file" id="inputFileUpload">
                    </div>
                    <div class="mt-2 p-3 col">
                        <button @click.prevent="submitForm" class="btn btn-primary">Добавить</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    export default {
        ...
        methods:{
            ...
            SaveAlbom() {
                ...
                axios.post('/api/home',{name:this.nameValue,description: this.descriptionValue,public: 0,user_id: this.userId})
           ...
           async submitForm(e) {
                ...
                formData.append('albom_id', this.albomid)
                // send upload request
